...
class ParameterTest(unittest.TestCase):
    ...
    def test_instance_parameter(self):
        ...
        cmd_arg, cmd_line, order, input_dict, output_dict = analyse.create_command_to_run_analysis(self.output_dir, subjects)
        cmd_tmp = 'C:/anywave_december_2019/AnyWave.exe --run D:\\Data\\testing\\test_dataset\\derivatives\\testing\\h2_parameters.json --input_file {0} --output_dir {1} --log_dir C:\\Users\\jegou\\AnyWave\\Log'
...
class DerivativesTest(unittest.TestCase):
    ...
    def test_update_dataset_after_analysis_input_files(self):
        ...
        self.assertEqual(datadesc['SourceDataset']['Input_--input_file'], {'modality': ['Ieeg'], 'ses': ['01'], 'task': ['ccep'], 'run': ['03', '02', '01']})
