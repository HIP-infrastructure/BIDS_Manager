...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(200, 260, 300, 32))
        ...
        self.lineEdit_uploaderlastname.setGeometry(QtCore.QRect(30, 130, 200, 20))
        ...
        self.lineEdit_uploaderfirstname.setGeometry(QtCore.QRect(30, 160, 200, 20))
        ...
        self.lineEdit_uploaderdate.setGeometry(QtCore.QRect(30, 190, 200, 20))
        ...
        self.lineEdit_filelastname.setGeometry(QtCore.QRect(260, 130, 200, 20))
        ...
        self.lineEdit_filefirstname.setGeometry(QtCore.QRect(260, 160, 200, 20))
        ...
        self.lineEdit_filebirthdate.setGeometry(QtCore.QRect(260, 190, 200, 20))
        self.lineEdit_filebirthdate.setObjectName(_fromUtf8("lineEdit_filebirthdate"))
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(20, 20, 500, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label.setFont(font)
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(30, 100, 400, 20))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(260, 100, 200, 20))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(30, 250, 200, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
