...
megserv_dir = r'\\dynaserv\apps\Plugins_Windows\Bids_Pipeline'
...
cmd_line = 'pyinstaller --onefile --name bids_manager --icon=bids_manager\\bids_manager.ico bids_manager\\bids_manager.py'
